...
class _WithBuilder extends State<WithBuilder> {
  ...
  List<ItemData> data = [
    ItemData(Colors.blue, "assets/LOVE.png", "Hi", "It's Me", "Sahdeep"),
    ItemData(Colors.deepPurpleAccent, "assets/LOVE.png", "Take a", "Look At",
        "Liquid Swipe"),
    ItemData(Colors.green, "assets/LOVE.png", "Liked?", "Fork!", "Give Star!"),
    ItemData(Colors.yellow, "assets/LOVE.png", "Can be", "Used for",
        "Onboarding design"),
    ItemData(
        Colors.pink, "assets/LOVE.png", "Example", "of a page", "with Gesture"),
    ItemData(Colors.red, "assets/LOVE.png", "Do", "try it", "Thank you"),
  ];
