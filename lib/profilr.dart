                  ...
                  Padding(
                    ...
                    child: SizedBox(width: 130,height: 130,
                        child: ClipRRect(borderRadius: BorderRadius.circular(100),
                          child: CircleAvatar(backgroundImage: AssetImage("assets/LOVE.png"),),
                        )),
                  ),
                  Column(
                    children: [
                      ...
                      Column(
                        children: [
                          Text("Anurag",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
                          Text("anuragpullambra@gmail.com"),
